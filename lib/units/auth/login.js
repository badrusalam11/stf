...
module.exports = function(options) {
  ...
  app.set('views', pathutil.resource('auth/login/views'))
  ...
  app.post('/auth/api/v1/login', requtil.validators.localLoginValidator, function(req, res) {
    ...
    switch (req.accepts(['json'])) {
      case 'json':
        requtil.validate(req)
          ...
          .then(function(user) {
            // log.info('Authenticated "%s"', loginutil.email(user))
            console.log(user)
          ...
          .catch(loginutil.InvalidCredentialsError, function(err) {
